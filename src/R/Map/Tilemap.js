(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    /* -------------------------------------------------
       ...
       ------------------------------------------------- */
    define(['src/R/System/Emitter', 'src/R/Graphic/Color', 'src/R/Map/Tileset'], factory);
    ...
    if (exists(root, "R.Map.Tileset") === false){
      throw new Error("Missing required object");
    }

    def(root, "R.Map.Tilemap", factory(
